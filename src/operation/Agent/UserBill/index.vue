...
import { USER_BILL_ORDER_TYPE_MAP, USER_BILL_ORDER_TYPE_OPTIONS } from '../constants'
...
const getOrderDestination = (row: UserBillItemV1) => {
  switch (Number(row.kind)) {
    case 1:
    case 2:
      return { path: '/operation/recharge_order', query: { order_num: row.order_id } }
    case 3:
      return { path: '/operation/flash_exchange', query: { keyword: row.order_id } }
    case 4:
    case 5:
    case 6:
    case 7:
    ...
    case 10:
    case 20:
      return { path: '/operation/energy_transaction', query: { keyword: row.order_id } }
    case 15:
    case 21:
      return { path: '/operation/quick_charge_order', query: { keyword: row.order_id } }
    default:
      return isQuickChargeBill(row)
        ? { path: '/operation/quick_charge_order', query: { keyword: row.order_id } }
        : undefined
  }
}
