...
import { v1SendGroupMessage, type SendGroupMessageParamsV1 } from '@/api/opertion/common/tgUser'
import { v1GetInnerButtonList } from '@/api/opertion/common/menuList'
import type { InnerButtonItem } from '@/api/opertion/common/menuList/types'
import { uploadFileV2 as uploadAPI } from '@/api/opertion/common/upload'
import { useHtmlInsert } from '@/hooks/web/useHtmlInsert'
import { getErrorMessage } from '@/utils/messageHelper'

// 导入子组件
import MessageContentEditor from '@/operation/components/MessageDialog/MessageContentEditor.vue'
